...
function initSidebar() {
  ...
  // Set active based on URL hash or default
...
function renderHistory() {
  ...
  el.innerHTML = App.history.slice(0, 20).map(h =>
    `<div class="history-item" onclick="navigateTo('${h.page}');toggleHistory()">
      <div>${h.title}</div>
  ...
  document.addEventListener('keydown', (e) => {
    ...
    if (e.ctrlKey || e.metaKey) {
      switch (e.key.toLowerCase()) {
        ...
        case 'p': e.preventDefault(); navigateTo('products'); break;
        case 'c': e.preventDefault(); navigateTo('cases'); break;
        case 'm': e.preventDefault(); navigateTo('mycases'); break;
        case 'n': e.preventDefault(); navigateTo('nas'); break;
        case 'a': e.preventDefault(); navigateTo('analytics'); break;
        case 's': e.preventDefault(); navigateTo('settings'); break;
